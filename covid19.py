...
def main():
    ...
    print("!!!                           .../NOTE\...                                             !!! ")                                                           
    print("!!!                                                                                    !!!")
    print("!!!  If sockets count < the attacking. sockets: The attack success ;)                  !!!")
    print("!!!  If sockets count = 0: Host is down, check the domain name or connection error.    !!!")
    print("!!!  If scockets count = attacking sockets: Server is elastic host TRY DDoS GOOD LUCK! !!!")
    print("!!!                                                                                    !!! ")
