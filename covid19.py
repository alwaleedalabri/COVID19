...
def main():
    ...
    logging.info("!!!  If sockets count < the attacking. sockets: The attack success, if the socket count dropped to 0 means you killed to server:). !!!")
    logging.info("!!!                                                                                                                                !!! ")
    logging.info("!!!                                        ../FOR MORE INFO CHECK README.md FILE\..                                                !!! ")
    logging.info("!!!                                                                                                                                !!! ")
    logging.info("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    logging.info(" ")
