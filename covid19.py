...
def main():
    ...
    print("█              ---CREATED BY: ASA, SULTANATE OF OMAN---              █")
    print("█                                                                    █")
    print("█                                                                    █")
    print("█            [+]═══════════[OUTPUT NOTES]═══════════[+]              █")              
    print("█                                                                    █")
    print("█    Sockets count < the attacking sockets: attack success           █")
    print("█   Scockets count = attacking sockets: Server is elastic TRY DDoS   █")
    print("█ Sockets count = 0: Host is down, incorrect URL or connection error █")
    print("█                                                                    █")
    print("█                  FOR MORE INFO CHECK README.md FILE                █")
    print("█                                                                    █")
    print("█                                                              v1.2  █")
    print("└════════════════════════════════════════════════════════════════════┘")
    print(" ")
